...
**Last commit:** `fbc1102` — Keybind compact: 60px -> 40px per binding
...
- **[2026-06-21]** Claude Opus 4.7: Keybind compact: 60px -> 40px per binding (`fbc1102`)

- **[2026-06-21]** Claude Opus 4.7: Breathing room: more padding between sections and menu edges (`d179bff`)

- **[2026-06-21]** Claude Opus 4.7: CS2 density pass: smaller everything, more fits per page (`37b19fc`)
...
- **[2026-06-21]** Claude Opus 4.7: CS2 final polish: accent stripe under topbar matches section lines (`083ab16`)

- **[2026-06-21]** Claude Opus 4.7: CS2 vibe: section UIStroke border + accent underline under title bar (`7d3e057`)
...
- **[2026-06-21]** Claude Opus 4.7: Slider track: visible mid-gray + subtle stroke so range is obvious (`d09e2af`)
